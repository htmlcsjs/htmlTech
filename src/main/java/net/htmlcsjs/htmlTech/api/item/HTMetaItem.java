package net.htmlcsjs.htmlTech.api.item;
...
import net.htmlcsjs.htmlTech.api.item.behaviors.LaserInspectorToolBehaviour;
...
import static net.htmlcsjs.htmlTech.api.item.HTMetaItems.*;
